...
import periodic_table from './index.jsx';
import { Layout } from './statecontroller.js';

class ChartProcessor extends React.Component {
    static HIGHLIGHT = '\u001b[7m';
    static OFF = '\u001b[0m';
    ...
    static _findElement(atomicNumber) {
        for (let row = 0; row < Layout.PeriodicTable.length; row++) {
            for (let column = 0; column < Layout.PeriodicTable[row].length; column++) {
